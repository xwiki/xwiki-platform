...
/**
 * Unit test for {@link FormUrlEncodedPropertyReader}.
 *
 * @version $Id$
 */
@ComponentTest
class FormUrlEncodedPropertyReaderTest
{
    @InjectMockComponents
    private FormUrlEncodedPropertyReader reader;

    @MockComponent
    private JAXRSUtils jaxrs;

    @Test
    void readsFirstPropertyField() throws Exception
    {
        MultivaluedMap<String, String> form = new MultivaluedHashMap<>();
        form.putSingle("property#foo", "bar");
