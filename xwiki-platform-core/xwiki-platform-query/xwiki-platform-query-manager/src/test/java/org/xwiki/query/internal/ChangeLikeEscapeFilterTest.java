...
/**
 * Unit tests for {@link ChangeLikeEscapeFilter}.
 *
 * @version $Id$
 * @since 8.4.5
 * @since 9.3RC1
 */
public class ChangeLikeEscapeFilterTest
{
    @Rule
    public MockitoComponentMockingRule<ChangeLikeEscapeFilter> mocker =
        new MockitoComponentMockingRule<>(ChangeLikeEscapeFilter.class);
    ...
    public void filterWithNamedParameterAndNoEscape() throws Exception
    {
        ...
        when(query.getStatement()).thenReturn("where ref like :reference and doc.space=:space");

        Map<String, Object> parameters = new LinkedHashMap<>();
        parameters.put("reference", "wiki:space1.space\\.2.space!3.%");
        ...
        assertEquals("where ref like :reference ESCAPE '!' and doc.space=:space", filteredQuery.getStatement());
    ...
    public void filterWithNamedParameterAndLikeAtEnd() throws Exception
    {
        Query query = mock(Query.class);
        when(query.getLanguage()).thenReturn(Query.HQL);
        when(query.getStatement()).thenReturn("where ref like :reference");
        ...
        Query filteredQuery = this.filter.filterQuery(query);
        assertEquals("where ref like :reference ESCAPE '!'", filteredQuery.getStatement());
    ...
    public void filterWithNamedParameterAndEscape() throws Exception
    {
        Query query = mock(Query.class);
        when(query.getLanguage()).thenReturn(Query.HQL);
        when(query.getStatement()).thenReturn("where ref like :reference escape '|'");
    ...
    public void filterWithPositionalParameterAndNoEscape() throws Exception
    {
        Query query = mock(Query.class);
        when(query.getLanguage()).thenReturn(Query.HQL);
        when(query.getStatement()).thenReturn("where ref like ? and doc.space=:space");

        Map<Integer, Object> positionalParameters = new LinkedHashMap<>();
        positionalParameters.put(1, "wiki:space1.space\\.2.space!3.WebHome");
        ...
        Query filteredQuery = this.filter.filterQuery(query);
        assertEquals("where ref like ? ESCAPE '!' and doc.space=:space", filteredQuery.getStatement());
    ...
    public void filterWithNumberedPositionalParameterAndNoEscape() throws Exception
    {
        Query query = mock(Query.class);
        when(query.getLanguage()).thenReturn(Query.HQL);
        when(query.getStatement()).thenReturn("where doc.space=?2 and ref like ?1");
        ...
        Query filteredQuery = this.filter.filterQuery(query);
        assertEquals("where doc.space=?2 and ref like ?1 ESCAPE '!'", filteredQuery.getStatement());
        assertEquals("wiki:space1.space\\.2.space!!3.WebHome", filteredQuery.getPositionalParameters().get(1));
    ...
    public void filterWithPositionalParameterAndFunction() throws Exception
    {
        Query query = mock(Query.class);
        when(query.getLanguage()).thenReturn(Query.HQL);
        when(query.getStatement()).thenReturn("where ref like LOWER(?)");
        ...
        Query filteredQuery = this.filter.filterQuery(query);
        assertEquals("where ref like LOWER(?) ESCAPE '!'", filteredQuery.getStatement());
        assertEquals("wiki:space1.space\\.2.space!!3.WebHome", filteredQuery.getPositionalParameters().get(1));
    }
}
