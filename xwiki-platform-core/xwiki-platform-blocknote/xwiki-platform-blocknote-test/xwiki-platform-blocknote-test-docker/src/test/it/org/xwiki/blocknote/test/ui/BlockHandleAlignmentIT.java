 ...
 * of its block, regardless of the block's type, font size or content, since the handle is positioned by measuring
 * the actual rendered line at runtime (see {@code centerOnFirstLine} in the {@code blocknote-react} module) rather
 * than a fixed, per-block-type offset.
 *
 * @version $Id$
 * @since 18.9.0RC1
 */
