...
class RepositoryScriptServiceTest
{
    ...
    void beforeEach() throws Exception
    {
        ...
        when(this.xwiki.getDocument(MAIN_DOCUMENT_REFERENCE, this.xcontext)).thenReturn(this.mainDocument);
    ...
    {
        when(this.extensionStore.getExistingExtensionDocumentReferenceById(EXTENSION_ID))
            .thenReturn(MAIN_DOCUMENT_REFERENCE);
    ...
    {
        when(this.extensionStore.getExistingProjectDocumentReferenceById(PROJECT_ID))
            .thenReturn(MAIN_DOCUMENT_REFERENCE);
    ...
    void getVersionObjectWhenAuthorCannotViewExtensionDocument() throws Exception
    {
        ...
        verify(this.xwiki, never()).getDocument(MAIN_DOCUMENT_REFERENCE, this.xcontext);
        verify(this.xwiki, never()).getDocument(VERSION_DOCUMENT_REFERENCE, this.xcontext);
    }
    ...
    {
        when(this.extensionStore.getExistingExtensionDocumentReferenceById(EXTENSION_ID)).thenReturn(null);
    ...
    {
        when(this.extensionStore.getExistingProjectDocumentReferenceById(PROJECT_ID)).thenReturn(null);
