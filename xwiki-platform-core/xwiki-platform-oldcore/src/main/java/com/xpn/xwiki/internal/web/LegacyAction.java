...
public interface LegacyAction
{
    ...
    {
        execute(ServletBridge.toJakarta(servletRequest), ServletBridge.toJakarta(servletResponse));
    }
    ...
    {
        execute(ServletBridge.toJavax(servletRequest), ServletBridge.toJavax(servletResponse));
    }
}
