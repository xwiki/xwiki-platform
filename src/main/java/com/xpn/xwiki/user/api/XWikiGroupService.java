...
public interface XWikiGroupService {
	...
	/**
	 * @deprecated Use
	 *             {@link #getAllGroupsNamesForMember(String, int, int, XWikiContext)}.
	 */
	 ...
	 *            <li>fieldtype : for example StringProperty. If null the field
	 *            is considered as document field</li>
	 *            <li>pattern matching : based on HQL "like" command</li>
	 *            </ul>
	 * @param withdetails
	 *            indicate if a {@link List} containing {@link String} names is
	 *            returned or {@link List} containing
