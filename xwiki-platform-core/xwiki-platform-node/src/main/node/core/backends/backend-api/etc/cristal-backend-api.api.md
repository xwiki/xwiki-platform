## API Report File for "@manuelleducorg/backend-api"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AttachmentsData } from '@manuelleducorg/api';
import { Container } from 'inversify';
import { Logger } from '@manuelleducorg/api';
import { PageAttachment } from '@manuelleducorg/api';
import { PageData } from '@manuelleducorg/api';
import { Storage as Storage_2 } from '@manuelleducorg/api';
import { WikiConfig } from '@manuelleducorg/api';
