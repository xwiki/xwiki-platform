...
@Singleton
public class DatabaseInputWikiStreamFactory extends AbstractBeanInputWikiStreamFactory<DatabaseInputProperties>
{
    @Inject
    private Provider<XWikiContext> xcontextProvider;

    public DatabaseInputWikiStreamFactory()
    {
    ...
    @Override
    protected InputWikiStream createInputWikiStream(DatabaseInputProperties properties) throws WikiStreamException
    {
        return new DatabaseInputWikiStream(this.xcontextProvider, properties);
    }
}
