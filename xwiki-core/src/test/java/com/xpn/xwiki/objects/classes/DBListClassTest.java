...
public class DBListClassTest extends TestCase
{
    ...
    public void testGetQueryWhenNoSQLSCriptSpecified()
    {
        ...
        assertEquals("select idprop.value, idprop.value from XWikiDocument as doc, BaseObject as obj, "
            + "StringProperty as idprop where doc.fullName=obj.name and obj.className='' and obj.id=idprop.id.id "
