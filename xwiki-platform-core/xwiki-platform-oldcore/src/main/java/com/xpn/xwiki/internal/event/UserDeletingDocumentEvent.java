 ...
 * @since 10.11.10
 */
public class UserDeletingDocumentEvent extends DocumentDeletingEvent implements UserEvent
{
     ...
     */
    public UserDeletingDocumentEvent()
    {
    }
     ...
     */
    public UserDeletingDocumentEvent(DocumentReference userReference, DocumentReference documentReference)
    {
    ...
    /**
     * @return the user responsible for the modifications
     */
    @Override
