 ...
 */
package org.xwiki.lesscss.internal.compiler.lessjs;
...
/**
 * JavaScript implementation of {@link LESSCompiler}. It uses Rhino to run the official LESS compiler, written in
 * Javascript. Performances are not very good, but all features work and it is easy to keep it up-to-date.
 *
 * @since 6.4M2
 * @version $Id$
 */
...
@Singleton
@Named("javascript")
public class JavaScriptLESSCompiler implements LESSCompiler, Initializable
{
