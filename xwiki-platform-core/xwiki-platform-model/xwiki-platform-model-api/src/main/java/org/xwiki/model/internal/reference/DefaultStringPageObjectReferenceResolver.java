 ...
 * component to resolve {@link PageObjectReference} objects from their string representation. This implementation uses
...
@Component
@Singleton
public class DefaultStringPageObjectReferenceResolver implements PageObjectReferenceResolver<String>
{
    /**
    ...
    @Override
    public PageObjectReference resolve(String objectReferenceRepresentation, Object... parameters)
    {
