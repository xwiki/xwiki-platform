...
@Named("xar/1.0")
@Singleton
public class DatabaseOutputWikiStreamFactory extends AbstractBeanOutputWikiStreamFactory<DatabaseOutputProperties>
{
    public DatabaseOutputWikiStreamFactory()
    {
    ...
    @Override
    public OutputWikiStream creaOutputWikiStream(DatabaseOutputProperties properties) throws WikiStreamException
    {
        return new DatabaseOutputWikiStream(properties);
    }
}
