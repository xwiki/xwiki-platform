...
public interface XWikiPluginInterface
{
    ...
    /**
     * Plugin extension point allowing the plugin to perform modifications to an attachment when the user clicks on an
     * attachment in a document. The plugin is passed the original attachment and it has to return the new modified
     * attachment.
     * 
