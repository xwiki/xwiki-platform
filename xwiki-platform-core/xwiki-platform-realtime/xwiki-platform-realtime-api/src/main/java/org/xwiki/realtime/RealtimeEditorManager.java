...
public interface RealtimeEditorManager
{
    ...
    /**
     * Determine the currently selected editor.
     * Expected outputs can be but are not limited to "inplace", "inline", "wysiwyg", "wiki"...
     * 
     ...
     * @param locale Specifies the translation of the document to be selected.
     ...
     */
    Boolean sessionIsActive(DocumentReference target, String locale, String editor);
