...
public interface LiveDataEntriesResource
{
     ...
     * @param query the query used to sort, filter or limit the live data entries
     ...
     * @return the list of live data entries that match the given query
     * @throws Exception if retrieving the live data entries fails
     */
    @GET
    Entries getEntries(
        @PathParam("sourceId") String sourceId,
        @QueryParam("query") LiveDataQuery query,
