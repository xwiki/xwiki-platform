 ...
 * @since 16.8.0RC1
 */
public class ExtensionSupporterInlinePage extends InlinePage
{
    @FindBy(name = "title")
    private WebElement supporterPlanNameInput;

    @FindBy(name = "ExtensionCode.ExtensionSupporterClass_0_active")
    ...
    @Override
    public ExtensionSupporterPage clickSaveAndView()
    {
