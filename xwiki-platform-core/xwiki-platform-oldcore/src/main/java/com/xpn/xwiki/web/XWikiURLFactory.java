...
public interface XWikiURLFactory
{
     ...
     *        of 'a=&b=c' which can understood either as 'a' = '&b=c' or as 'a' = '' and 'b' = 'c'). Ideally we would
     *        need an API signature that accepts a {@code Map&lt;String, String&gt;} for the Query String.
     */
