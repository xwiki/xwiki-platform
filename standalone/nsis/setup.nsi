...
LangString ^DesktopShortcutsDescription ${LANG_FRENCH} "Installe sur votre bureau des raccourcis pour démarrer/arréter l'application."
LangString ^XWikiFilesDescription ${LANG_ENGLISH} "Copy all the files needed by $(^Name)."
LangString ^XWikiFilesDescription ${LANG_FRENCH} "Installe les fichiers nécessaires à $(^Name)."
...
LangString ^DatabaseBootstrapDescription ${LANG_FRENCH} "Copie les données du wiki. Nécessaire en cas de première installation.$\r$\nATTENTION: efface les données actuelles en cas de mise à jour d'une installation précédente."
LangString ^ShortcutsDescription ${LANG_ENGLISH} "Installs start/stop shortcuts in the Start menu"
LangString ^ShortcutsDescription ${LANG_FRENCH} "Installe des raccourcis pour démarrer/arréter l'application dans le menu Démarrer"
...
LangString ^ShortcutsComponent ${LANG_FRENCH} "Raccourcis menu Démarrer"
...
LangString ^DatabaseBootstrapComponent ${LANG_FRENCH} "Données wiki"
