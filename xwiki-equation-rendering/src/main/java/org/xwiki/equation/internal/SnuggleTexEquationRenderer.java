...
/**
 * Implementation of the {@link EquationRenderer} component, which uses <a
 * href="http://snuggletex.sf.net/">SnuggleTeX</a> for generating the images corresponding to the rendered mathematical
 * equations. The results are not as eye-pleasing as those obtained from the native TeX system, but this is a pure-java
...
public final class SnuggleTexEquationRenderer extends AbstractEquationRenderer
{
    /** Logging helper object. */
    private static final Log LOG = LogFactory.getLog(SnuggleTexEquationRenderer.class);

    /** The SnuggleTeX engine responsible for rendering the equations. */
        ...
        EquationRenderer.Type type) throws IllegalArgumentException, IOException
    {
        ...
        SnuggleInput input = new SnuggleInput(wrapEquation(equation, inline));
