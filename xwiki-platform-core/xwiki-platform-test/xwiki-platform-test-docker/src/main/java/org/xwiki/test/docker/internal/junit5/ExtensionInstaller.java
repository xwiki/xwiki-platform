...
public class ExtensionInstaller
{
    ...
    {
        this.restExtensionInstaller.installExtensions(DockerTestUtils.getXWikiExecutor(this.context).getHttpBaseURL(),
            extensions, credentials, installUserReference, namespaces, failOnExist);
    }
}
