...
public class XMLScriptServiceTest extends AbstractComponentTestCase
{
    ...
    {
        Assert.assertFalse("' wrongly escaped to non-HTML &apos;", XMLScriptService.escape("'").equals("&apos;"));
    }
    ...
    {
        Assert.assertTrue("Non-ASCII characters were escaped", XMLScriptService.escape("\u0123").equals("\u0123"));
    }
    ...
    public void testEscapeForAttributeValue()
    {
        ...
        String escapedText = XMLScriptService.escapeForAttributeValue("a < a' && a' < a\" => a < a\"");
    ...
    {
        Assert.assertFalse("' wrongly escaped to non-HTML &apos;", XMLScriptService.escapeForAttributeValue("'")
            .equals("&apos;"));
    }
    ...
    {
        Assert.assertEquals("\"\" should be \"\"", "", XMLScriptService.escapeForAttributeValue(""));
    }
    ...
    {
        Assert.assertTrue("Non-ASCII characters were escaped", XMLScriptService.escapeForAttributeValue("\u0123")
            .equals("\u0123"));
    }
    ...
    public void testEscapeForElementContent()
    {
        ...
        String escapedText = XMLScriptService.escapeForElementContent("a < a' && a' < a\" => a < a\"");
    ...
    {
        Assert.assertEquals("\"\" should be \"\"", "", XMLScriptService.escapeForElementContent(""));
    }
    ...
    {
        Assert.assertTrue("Non-ASCII characters were escaped", XMLScriptService.escapeForElementContent("\u0123")
            .equals("\u0123"));
    }
    ...
    {
        Assert.assertEquals("Extra named entities were unescaped", "&deg;", XMLScriptService.unescape("&deg;"));
        Assert.assertEquals("Extra decimal entities were unescaped", "&#65;", XMLScriptService.unescape("&#65;"));
        Assert.assertEquals("Extra hexadecimal entities were unescaped", "&#x5;", XMLScriptService.unescape("&#x5;"));
    }
