 ...
 * @version $Id: $
 */
public class StringMacroParameterTest extends AbstractRenderingTestCase
{
    StringMacroParameterDescriptor intDesc;
    ...
    protected void setUp() throws Exception
    {
        ...
        this.intDesc = new StringMacroParameterDescriptor("name", "desc", "default string");
    }

    public void testGetValue() throws MacroParameterException
    {
        StringMacroParameter param = new StringMacroParameter(this.intDesc, "some stRing");
