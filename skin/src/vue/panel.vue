...
-->
<template>
        <div :id="panelidname" v-html="content.currentContent"></div>
</template>
<script lang="ts">
import { inject, ref } from 'vue';
import { Logger, PageData, CristalApp } from '@cristal/api';
...
export default {
    ...
    setup(props) {
        ...
        if (cristal!=null) {
            ...
            cristal.getWikiConfig().storage.getPanelContent(panelName, "", "html").then(function (panelData: PageData) {
                if (panelData.html=="") {
                    panelData.html = cristal.renderContent(panelData.source, panelData.syntax, "html", cristal.getWikiConfig());
                }
        ...
        return { content : contentMap.get(props.panelName), 
