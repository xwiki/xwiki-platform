    ...
    public String render(XWikiContext context) throws XWikiException {
        try {
            ...
            if ((format==null)||(format.equals("xar"))) {
                ...
                context.getResponse().addHeader("Content-disposition", "inline; filename=" + Utils.encode(doc.getSpace(), context) + "_" + Utils.encode(doc.getName(), context) + "." + format);
