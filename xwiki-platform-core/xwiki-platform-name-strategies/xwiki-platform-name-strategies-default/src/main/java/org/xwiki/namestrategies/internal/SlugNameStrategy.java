...
@Component
@Singleton
@Named(SlugNameStrategy.COMPONENT_NAME)
public class SlugNameStrategy extends AbstractEntityReferenceNameStrategy
{
    protected static final String COMPONENT_NAME = "SlugNameStrategy";
