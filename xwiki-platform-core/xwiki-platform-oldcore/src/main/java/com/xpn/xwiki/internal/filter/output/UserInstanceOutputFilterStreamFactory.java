...
@Singleton
public class UserInstanceOutputFilterStreamFactory
    extends AbstractBeanOutputInstanceFilterStreamFactory<UserInstanceOutputProperties, UserInstanceOutputFilter>
{
    /**
