...
public class XWikiDockerExtension extends AbstractExecutionConditionExtension
{
    ...
    private void beforeAllInternal(ExtensionContext extensionContext) throws Exception
    {
        ...
        for (int index = 0; index < testConfiguration.getXWikiInstances().value(); ++index) {
            ...
            if (testConfiguration.getServletEngine().equals(ServletEngine.EXTERNAL)) {
                ...
                executor = new XWikiExecutor(index, GenericContainer.INTERNAL_HOST_HOSTNAME, 8080,
                ...
                executor = containerExecutor.start(targetWARDirectory);
            }
    ...
    public void afterAll(ExtensionContext extensionContext) throws Exception
    {
        ...
        if (Boolean.getBoolean(KEEP_RUNNING_PROPERTY)
            ...
            XWikiExecutor executor = DockerTestUtils.getXWikiExecutor(0, extensionContext);
