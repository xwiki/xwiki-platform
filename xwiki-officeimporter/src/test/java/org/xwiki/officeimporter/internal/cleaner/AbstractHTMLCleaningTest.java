...
public class AbstractHTMLCleaningTest extends AbstractRenderingTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        this.openOfficeHTMLCleaner = (HTMLCleaner) getComponentManager().lookup(HTMLCleaner.ROLE, "openoffice");
        this.wysiwygHTMLCleaner = (HTMLCleaner) getComponentManager().lookup(HTMLCleaner.ROLE, "wysiwyg");
    }
