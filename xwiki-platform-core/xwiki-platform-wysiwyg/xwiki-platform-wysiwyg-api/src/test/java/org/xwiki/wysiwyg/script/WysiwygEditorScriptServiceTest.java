...
class WysiwygEditorScriptServiceTest
{
    ...
    void toAnnotatedXHTML() throws Exception
    {
        ...
        assertEquals(expectedSource, this.editorScriptService
            .toAnnotatedXHTML(source, syntax, sourceReference, restricted));
        verify(this.authorExecutor)
            .call(any(Callable.class), eq(contentAuthorRef), eq((DocumentReference) sourceReference));
    }
}
