...
public class DefaultChartParams2 extends ChartParams {
	...
	protected DefaultChartParams2() throws ParamException {
		...
		List colors = new LinkedList(); colors.add(null);
		colors.add(null); colors.add(null); colors.add(null);
	...
	void setAxis(String prefix) throws ParamException {
		...
		set(prefix+NUMBER_AXIS_AUTO_RANGE_INCLUDES_ZERO_SUFFIX, new Boolean(NumberAxis.DEFAULT_AUTO_RANGE_INCLUDES_ZERO));
