...
public class RenderingTests extends TestCase
{
    ...
    public static void setUpMocks(EmbeddableComponentManager componentManager) throws Exception
    {
        ...
        // Configuration Mock
        final EquationMacroConfiguration mockConfiguration = context.mock(EquationMacroConfiguration.class);
        DefaultComponentDescriptor<EquationMacroConfiguration> descriptorEMC =
            new DefaultComponentDescriptor<EquationMacroConfiguration>();
        descriptorEMC.setRole(EquationMacroConfiguration.class);
