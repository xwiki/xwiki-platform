 ...
 * component to resolve {@link PageReference} objects from Entity Reference (when they miss some parent references or
...
@Named("current")
@Singleton
public class CurrentReferencePageReferenceResolver implements PageReferenceResolver<EntityReference>
{
    @Inject
    @Named("current")
