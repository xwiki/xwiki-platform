 ...
 * component to resolve {@link org.xwiki.model.reference.PageAttachmentReference} objects from Entity Reference (when
 * they miss some parent references or have NULL values). This implementation uses fixed default values when parts of
 * the Reference are missing in the string representation. Default values are retrieved from the
...
@Component
@Singleton
public class DefaultReferencePageAttachmentReferenceResolver implements PageAttachmentReferenceResolver<EntityReference>
{
    /**
