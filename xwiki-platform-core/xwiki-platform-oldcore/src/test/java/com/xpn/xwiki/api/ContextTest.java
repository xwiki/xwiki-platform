...
class ContextTest
{
    ...
    void setDisplayMode() throws Exception
    {
        ...
        assertEquals("<input aria-label='core.model.xclass.editClassProperty.textAlternative' id='space.page_0_prop' "
            + "name='space.page_0_prop' maxlength='255' value='value' size='5' type='text'/>",
