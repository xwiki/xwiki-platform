...
{
    /**
     * The default XHTML Link Renderer that we're wrappping.
     */
    @Requirement
        ...
        Map<String, String> parameters)
    {
        ...
        getXHTMLWikiPrinter().printXMLComment("startwikilink:" + this.xwikiSyntaxLinkRenderer.renderLinkReference(link),
            true);
