...
public class GroupTest extends AbstractTest
{
    ...
    public void addUserAndSubgroupToGroup() throws Exception
    {
        ...
        assertTrue("bigGroup not added!", groupsPage.getGroupsTable().hasRow("Group Name", BIG_GROUP));
        assertTrue("subGroup not added!", groupsPage.getGroupsTable().hasRow("Group Name", SUB_GROUP));
        ...
        assertTrue("SUB_GROUP is not part of BIG_GROUP!",
            bigGroupPage.getMembersTable().hasRow("Member", "subGroup (XWiki.subGroup)"));
