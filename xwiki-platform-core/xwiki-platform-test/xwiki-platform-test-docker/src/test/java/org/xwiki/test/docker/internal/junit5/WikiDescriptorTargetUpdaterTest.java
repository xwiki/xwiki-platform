...
class WikiDescriptorTargetUpdaterTest
{
    ...
    {
        assertEquals(WikiDescriptorTarget.BROWSER, resolve(NoAnnotation.class, "test", null));
        assertEquals(WikiDescriptorTarget.HTTP_CLIENT,
            resolve(NoAnnotation.class, "test", WikiDescriptorTarget.HTTP_CLIENT));
    }
    ...
    void resolveWhenMetaAnnotation() throws Exception
    {
        assertEquals(WikiDescriptorTarget.BROWSER,
            resolve(OnMetaAnnotatedClass.class, "test", WikiDescriptorTarget.HTTP_CLIENT));
    }
