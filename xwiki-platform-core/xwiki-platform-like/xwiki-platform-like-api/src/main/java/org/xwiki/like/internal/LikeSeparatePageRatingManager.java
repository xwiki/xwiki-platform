...
/**
 * A dedicated {@link org.xwiki.ratings.RatingsManager} that uses separate pages but with a dedicated space for Likes.
 *
 * @version $Id$
 * @since 12.7RC1
 */
...
@Singleton
@Named("like/separate")
public class LikeSeparatePageRatingManager extends SeparatePageRatingsManager
{
    @Override
