...
/**
 * Specialized implementation of {@link ColorThemeReferenceSerializer} to serialize {@link DocumentColorThemeReference}
 * references.
 *
 * @since 6.4M2
 * @version $Id$
 */
@Component
@Named("org.xwiki.lesscss.colortheme.DocumentColorThemeReference")
@Singleton
public class DocumentColorThemeReferenceSerializer implements ColorThemeReferenceSerializer
{
    @Inject
    ...
    public String serialize(ColorThemeReference colorThemeReference)
    {
        ...
        return String.format("ColorThemeDocument[%s]",
            entityReferenceSerializer.serialize(docColorThemeRef.getColorThemeDocument()));
    }
}
