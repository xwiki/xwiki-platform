...
{     
     ...
     * @throws org.xwiki.lesscss.LESSCompilerException if problem occurs
     */
    public String getCacheKey() throws LESSCompilerException
    {
        ...
        URL urlFactoryGeneratedURL = urlFactory.createSkinURL("style.css", 
            skinDirectoryGetter.getFileSystemSkin(xcontext.getWiki().getSkin(xcontext)),
                xcontext);
