...
/**
 * Required rights analyzer for {@code XWiki.EventStream.Code.EventClass}.
 *
 * @version $Id$
 * @since 15.10.16
 * @since 16.4.7
...
@Singleton
public class EventClassRequiredRightAnalyzer implements RequiredRightAnalyzer<BaseObject>
{
    @Inject
