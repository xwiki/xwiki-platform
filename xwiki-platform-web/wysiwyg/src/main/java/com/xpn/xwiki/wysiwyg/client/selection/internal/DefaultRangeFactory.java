...
{
    private static DefaultRangeFactory instance;

    private DefaultRangeFactory()
    {
    }

    public static synchronized DefaultRangeFactory getInstance()
    {
        if (instance == null) {
            instance = new DefaultRangeFactory();
        }
        return instance;
    }
