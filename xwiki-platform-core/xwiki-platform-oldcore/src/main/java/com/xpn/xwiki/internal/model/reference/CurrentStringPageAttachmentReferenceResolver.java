 ...
 * component to resolve {@link PageAttachmentReference} objects from their string representation. The behavior is the
 * one defined in {@link com.xpn.xwiki.internal.model.reference.CurrentStringEntityReferenceResolver}.
 *
 * @version $Id$
 * @since 10.6RC1
 */
