...
/**
 * Renders the passed list of gadgets as a piece of XDOM, to be added in a tree after. It also handles layout of the
 * gadgets. Various implementations of this class should provide various strategies of gadgets rendering, mainly
 * different through their layout.
 * 
 * @version $Id$
 * @since 3.0M3
 */
...
public interface DashboardRenderer
{
     ...
     */
    List<Block> renderGadgets(List<Gadget> gadgets, MacroTransformationContext context) throws Exception;
