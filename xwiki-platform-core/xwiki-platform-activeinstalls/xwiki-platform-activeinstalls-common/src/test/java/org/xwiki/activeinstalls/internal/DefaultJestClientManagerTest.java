...
@ComponentTest
public class DefaultJestClientManagerTest
{
    @InjectMockComponents
    private DefaultJestClientManager manager;

    @MockComponent
    private ActiveInstallsConfiguration configuration;

    @Test
    public void initializeWhenPingURLIsEmpty()
    {
    ...
    @Test
    public void initializeWhenPingURLIsNotEmpty()
    {
        // Note: Simulate call to initialize() since we cannot use @BeforeComponent annotation as we want different
        // init behaviors for the different tests methods.
