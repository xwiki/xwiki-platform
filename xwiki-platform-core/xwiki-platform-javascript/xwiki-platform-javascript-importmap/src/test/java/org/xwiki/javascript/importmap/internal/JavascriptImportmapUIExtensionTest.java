...
class JavascriptImportmapUIExtensionTest
{
    ...
    private JavascriptImportmapUIExtension javascriptImportmapUIExtension;
    ...
    void execute()
    {
        this.javascriptImportmapUIExtension.execute();
        verify(this.javascriptImportmapResolver).getBlock();
    }
}
