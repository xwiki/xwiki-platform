...
LangString ^StartXWikiLink ${LANG_FRENCH} "D?marrer $(^Name)"
LangString ^StopXWikiLink ${LANG_ENGLISH} "Stop $(^Name)"
LangString ^StopXWikiLink ${LANG_FRENCH} "Arr?ter $(^Name)"
LangString ^XWikiStopDescription ${LANG_ENGLISH} "Stop $(^Name) application"
LangString ^XWikiStopDescription ${LANG_FRENCH} "Arr?te l'application $(^Name)"
LangString ^XWikiStartDescription ${LANG_ENGLISH} "Start $(^Name) application"
LangString ^XWikiStartDescription ${LANG_FRENCH} "D?marre l'application $(^Name)"
...
LangString ^JavaNotFound ${LANG_FRENCH} "L'environnement d'ex?cution Java n'a pas ?t? trouv?. Vous devez installer la version 1.4 ou sup?rieure pour faire fonctionner $(^Name). Vous allez ?tre redirig? sur le site Java de Sun."
...
LangString ^OldJavaFound ${LANG_FRENCH} "La version de l'environnement d'ex?cution Java pr?sente sur votre syst?me est trop ancienne. Il faut installer la version 1.4 ou sup?rieure pour faire fonctionner $(^Name). Vous allez ?tre redirig? sur le site Java de Sun."
...
LangString ^ServerPortSubtitle ${LANG_FRENCH} "Choisissez un num?ro de port pour $(^Name). Celui-ci doit ?tre sup?rieur ? 1024."
...
LangString ^CustomInstType ${LANG_FRENCH} "Personnalis?e"
LangString ^UpdateInstType ${LANG_ENGLISH} "Update"
LangString ^UpdateInstType ${LANG_FRENCH} "Mise ? jour"
...
LangString ^DesktopShortcutsDescription ${LANG_FRENCH} "Installe sur votre bureau des raccourcis pour d?marrer/arr?ter l'application."
LangString ^XWikiFilesDescription ${LANG_ENGLISH} "Copy all the files needed by $(^Name)."
LangString ^XWikiFilesDescription ${LANG_FRENCH} "Installe les fichiers n?cessaires ? $(^Name)."
...
LangString ^DatabaseBootstrapDescription ${LANG_FRENCH} "Copie les donn?es du wiki. N?cessaire en cas de premi?re installation.$\r$\nATTENTION: efface les donn?es actuelles en cas de mise ? jour d'une installation pr?c?dente."
LangString ^ShortcutsDescription ${LANG_ENGLISH} "Installs start/stop shortcuts in the Start menu"
LangString ^ShortcutsDescription ${LANG_FRENCH} "Installe des raccourcis pour d?marrer/arr?ter l'application dans le menu D?marrer"
...
LangString ^ShortcutsComponent ${LANG_FRENCH} "Raccourcis menu D?marrer"
...
LangString ^DatabaseBootstrapComponent ${LANG_FRENCH} "Donn?es wiki"
LangString ^BadPortNumberTooLow ${LANG_ENGLISH} "Port number must be greater than 1024"
LangString ^BadPortNumberTooLow ${LANG_FRENCH} "Le port doit ?tre sup?rieur ? 1024"
LangString ^BadPortNumberTooHigh ${LANG_ENGLISH} "Port number must be less than 65535"
LangString ^BadPortNumberTooHigh ${LANG_FRENCH} "Le port doit ?tre inf?rieur ? 65535"
...
LangString ^UninstallWarning ${LANG_FRENCH} "Vous ?tes sur le point de d?sinstaller $(^Name).$\r$\nATTENTION: Toutes les donn?es du wiki vont ?tre d?truites ?galement. Pour sauvegarder vos donn?es, copiez les fichiers du r?pertoire 'db' en lieu s?r, avant de proc?der ? la d?sintallation."
...
LangString ^ConfigPortPrompt ${LANG_FRENCH} "Par d?faut, $(^Name) va utiliser le port 8080 pour fonctionner. Si cette valeur ne vous convient pas, merci d'en pr?ciser une autre."
LangString ^ConfigPortPort ${LANG_ENGLISH} "Port number:"
LangString ^ConfigPortPort ${LANG_FRENCH} "Port ? utiliser:"
LangString ^RunText ${LANG_ENGLISH} "Run $(^Name)"
LangString ^RunText ${LANG_FRENCH} "Lancer $(^Name)"
LangString ^FinishText ${LANG_FRENCH} "Pour utiliser $(^Name), il faut d?marrer le serveur en utilisant soit les raccourcis cr??s durant l'installation, soit le script $INSTDIR\xwikionjetty\start_xwiki.bat, puis en allant ? l'adresse suivante avec votre navigateur:\r\n\r\nhttp://localhost:$ServerPort/xwiki/bin/view/Main/WebHome\r\n\r\nCliquez sur 'Fermer' pour quitter l'installation."
...
LangString ^FinishTitle ${LANG_FRENCH} "$(^Name) est install?"
