...
define('xwiki-wysiwyg-attachment-service', [
  'xwiki-attachment-picker-solr-search',
], function (SolrSearch) {

  // Attachment cache
  let attachmentsByQuery = {};
  ...
  function getAttachments(query, isGlobal, force, editor, sort) {

    return new Promise(function (resolve) {

      const cached = attachmentsByQuery[(isGlobal ? "global" : "local")][query];
