...
public class PropertyChangedRule extends DocChangeRule {
    ...
    public PropertyChangedRule(XWikiNotificationInterface target,String classname, String propertyName) {
        setTarget(target);
    ...
    public boolean hasEqualProperty(XWikiDocInterface newdoc, XWikiDocInterface olddoc,
