 ...
 * @since 10.11.10
 */
public class UserUpdatingDocumentEvent extends DocumentUpdatingEvent implements UserEvent
{
     ...
     */
    public UserUpdatingDocumentEvent()
    {
    }
     ...
     */
    public UserUpdatingDocumentEvent(DocumentReference userReference, DocumentReference documentReference)
    {
