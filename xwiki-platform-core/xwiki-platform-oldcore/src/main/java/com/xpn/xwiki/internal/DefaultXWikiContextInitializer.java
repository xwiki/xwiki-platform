...
public class DefaultXWikiContextInitializer implements XWikiContextInitializer
{
    ...
    {
        XWikiServletContext xwikiEngine = new XWikiServletContext(ServletBridge.toJavax(request.getServletContext()));
        XWikiServletRequest xwikiRequest = new XWikiServletRequest(ServletBridge.toJavax(request));
        XWikiServletResponse xwikiResponse = new XWikiServletResponse(ServletBridge.toJavax(response));
