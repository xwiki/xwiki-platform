...
class DefaultPageActionCategoryService implements PageActionCategoryService {
  constructor(
    @multiInject("PageActionCategory")
    private actionCategories: PageActionCategory[],
  ) {}

  list(): PageActionCategory[] {
    return sortBy(this.actionCategories, ["order"]);
  }
}

export { DefaultPageActionCategoryService };
