 ...
 */
define('xwiki-wysiwyg-entity-resource-picker-translation-keys', {
  prefix: 'entityResourcePicker.',
  keys: [
    'select',
    'doc.title',
    'attach.title'
...
define('xwiki-wysiwyg-entity-resource-picker', [
  'jquery',
  'xwiki-wysiwyg-resource',
  'xwiki-wysiwyg-modal',
  'xwiki-l10n!xwiki-wysiwyg-entity-resource-picker-translation-keys',
  'xwiki-meta',
  'xwiki-tree'
