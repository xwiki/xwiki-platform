...
@Role
@Unstable
public interface NameStrategyConfiguration
{
    /**
     * @return the name of the current {@link EntityReferenceNameStrategy} to be used.
     */
    String getEntityReferenceNameStrategy();
