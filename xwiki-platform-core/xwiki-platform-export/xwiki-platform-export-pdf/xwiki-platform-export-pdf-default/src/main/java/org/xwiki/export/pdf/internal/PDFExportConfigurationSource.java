...
/**
 * Configuration source for the PDF export.
 *
 * @version $Id$
 * @since 14.8
 */
...
@Singleton
@Named("export/pdf")
public class PDFExportConfigurationSource extends AbstractWikisConfigurationSource
{
    private static final List<String> SPACE_NAMES = Arrays.asList("XWiki", "PDFExport");
    ...
    {
        return "configuration.document.export.pdf";
    }
}
