...
class NotificationMailDefaultHtmlTest extends PageTest
{
    ...
    void htmlEscaping() throws Exception
    {
        ...
        String expectedResult = "<table style=\"width: 100%\">\n"
            ...
            + "      </div>\n"
            + "                  <a style=\"color: $theme.linkColor; text-decoration: none;\" "
            ...
            + "    <table>\n"
            + "          <tr >\n"
            + "        <td style=\"border-right: 1px solid #E8E8E8; color: rgb(101, 101, 101); "
            + "font-family: Monospace; text-align: right; vertical-align: top;\">...</td>\n"
            + "        <td style=\"border-right: 1px solid #E8E8E8; color: rgb(101, 101, 101); "
            + "font-family: Monospace; text-align: right; vertical-align: top;\">...</td>\n"
            + "                <td class=\"diff-line \" style=\"background-color: #eee; "
            + "color: rgb(101, 101, 101); font-family: Monospace; padding: .4em .5em;\">@@ -1,0 +1,1 @@</td>\n"
            + "      </tr>\n"
            + "              <tr >\n"
            + "                    <td style=\"border-right: 1px solid #E8E8E8; color: rgb(101, 101, 101); "
            + "font-family: Monospace; text-align: right; vertical-align: top;\"></td>\n"
