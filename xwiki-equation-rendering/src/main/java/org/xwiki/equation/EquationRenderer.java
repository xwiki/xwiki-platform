...
/**
 * Convert a LaTeX equation into an image.
 * 
 * @version $Id$
 * @since 2.0M3
 */
...
{
    /**
     * Encloses the supported formats for rendered mathematical equations.
     * 
     * @version $Id$
     */
    ...
    /**
     * Encloses the supported LaTeX font sizes used for displaying a mathematical equation.
     * 
     * @version $Id$
     */
     ...
     * 
     * @param equation the mathematical equation to render, in LaTeX format, <em>without</em> the surrounding math-mode
     *            commands ($, begin{math}, etc.)
     * @param inline whether the equation appears inline inside the text, or as a standalone block
     ...
     */
    String process(String equation, boolean inline, FontSize size, Type type) throws IllegalArgumentException,
        IOException;
