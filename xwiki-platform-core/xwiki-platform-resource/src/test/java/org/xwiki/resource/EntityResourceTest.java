...
/**
 * Unit tests for {@link org.xwiki.resource.EntityResource}.
 *
 * @version $Id$
 * @since 6.0M1
 */
public class EntityResourceTest
{
    ...
    public void creation()
    {
        ...
        EntityResource resource = new EntityResource(reference, ActionId.VIEW);
        assertEquals(ActionId.VIEW, resource.getActionId());
