 ...
 */
@ComponentTest
@ComponentList({SimilarityCalculator.class, LegacyEventSearcher.class})
public class DefaultParametrizedNotificationManagerTest
{
    ...
    @Test
    void getEventsUC1() throws Exception
    {
        // Facts:
    ...
    @Test
    void getEventsUC2() throws Exception
    {
        // Facts:
    ...
    @Test
    void getEventsUC3() throws Exception
    {
        // Facts:
        // * Alice updates the page "Bike"
    ...
    @Test
    void getEventsUC5() throws Exception
    {
        // Facts:
        // * Bob updates the page "Bike"
    ...
    @Test
    void getEventsUC6() throws Exception
    {
        // Facts:
    ...
    @Test
    void getEvents1Update2Events() throws Exception
    {
        // Facts:
    ...
    @Test
    void getEventsXWIKI14454() throws Exception
    {
        // Facts:
    ...
    @Test
    void getEventsXWIKI14719() throws Exception
    {
