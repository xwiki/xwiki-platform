...
{
    /**
     * Tests if the start code of a day period is strictly less than its end code. This is needed
     * because the {@link XWikiStatsReader} retrieves the statistics that have been recorded between
    ...
    /**
     * Tests if the start code of a month period is strictly less than its end code. This is needed
     * because the {@link XWikiStatsReader} retrieves the statistics that have been recorded between
     * the start code, including it, and the end code, excluding it.
     */
    public void testMonthPeriodStartEndCode()
    {
