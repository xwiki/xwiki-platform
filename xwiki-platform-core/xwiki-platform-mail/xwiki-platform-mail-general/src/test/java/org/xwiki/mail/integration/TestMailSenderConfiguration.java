...
{
    private boolean obfuscateEmailAddresses;

    public TestMailSenderConfiguration(boolean obfuscateEmailAddresses)
    {
        this.obfuscateEmailAddresses = obfuscateEmailAddresses;
    }
