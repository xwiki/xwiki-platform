...
public class DefaultOpenOfficeServerManagerTest extends AbstractRenderingTestCase
{
    ...
    {
        super.setUp();
        this.oomanager = (OpenOfficeManager) getComponentManager().lookup(OpenOfficeManager.ROLE);
        this.ooconfig =
            (OpenOfficeConfiguration) getComponentManager().lookup(OpenOfficeConfiguration.ROLE);
    }
