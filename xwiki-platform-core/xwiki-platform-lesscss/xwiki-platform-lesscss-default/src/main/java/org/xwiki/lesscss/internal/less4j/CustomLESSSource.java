...
public class CustomLESSSource extends LessSource
{
    ...
    /**
     * Find referenced file in current path or one of search paths. Create new instance of CustomLessSource.
     *
     * @param filename name of the file to include
     * @return a new CustomLESSSource that wraps the file to include
     * @throws FileNotFound if the file is not found in any directory
     */
    @Override
