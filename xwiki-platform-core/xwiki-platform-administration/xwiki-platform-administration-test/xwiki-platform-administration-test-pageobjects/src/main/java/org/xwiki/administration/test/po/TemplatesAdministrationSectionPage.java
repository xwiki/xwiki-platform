...
public class TemplatesAdministrationSectionPage extends AdministrationSectionPage
{
    ...
    private void clickOnCreateButton()
    {
        ...
        getDriver().waitUntilCondition(input ->
            !getDriver().findElementsWithoutWaiting(By.cssSelector("form .LV_validation_message.LV_valid")).isEmpty()
                && getDriver().findElementsWithoutWaiting(By.cssSelector("form .LV_validation_message.LV_invalid"))
                .isEmpty());
