...
/**
 * Allows inserting HTML and XHTML in wiki pages. This macro also accepts wiki syntax alongside (X)HTML elements
 * (it's also possible to disable this feature using a macro parameter). When wiki syntax is used inside XML 
 * elements, the leading and trailing spaces and newlines are stripped.
 * 
 * @version $Id$
 * @since 1.6M1
 */
public class HTMLMacro extends AbstractMacro<HTMLMacroParameters>
{
    ...
    public HTMLMacro()
    {
        super(new DefaultMacroDescriptor(DESCRIPTION, HTMLMacroParameters.class));
    }
