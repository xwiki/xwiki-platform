...
public interface SpaceManagerExtension
{
    ...
    /**
     * Transform a title to a unique space name Adding a counter behind the space name
     * 
     * @param spaceTitle title of the space
    ...
    /**
     * API called to get the space type name defaults to "space"
     * 
     * @return
     */
    ...
    /**
     * API called to get the space class name defaults to XWiki.SpaceClass
     * 
     * @return
     */
     ...
     * @param deleteData
     * @param context
     * @return If it returns true, it will continue with the space creation, otherwise it will abord
     *         it
     */
