 ...
 * in {@link org.xwiki.model.internal.reference.ExplicitStringEntityReferenceResolver}.
 *
 * @version $Id$
 * @since 10.6RC1
 */
...
@Named("explicit")
@Singleton
public class ExplicitStringPageReferenceResolver implements PageReferenceResolver<String>
{
    /**
    ...
    @Override
    public PageReference resolve(String documentReferenceRepresentation, Object... parameters)
    {
