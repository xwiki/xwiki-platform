...
public class ScriptMimeMessage extends ExtendedMimeMessage
{
     ...
     *        {@code xwiki/template} it should be a {@link org.xwiki.model.reference.DocumentReference}, etc. Also accepts a 
     *        {@link BodyPart} object, in which case, the mime type is not used.
     */
