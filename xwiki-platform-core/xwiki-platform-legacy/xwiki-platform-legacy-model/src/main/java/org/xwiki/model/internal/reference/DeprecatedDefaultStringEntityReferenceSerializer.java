...
/**
 * Same as DefaultStringEntityReferenceSerializer but with the extended type in the role hint instead of the role type.
 * 
 * @version $Id$
 * @since 2.2M1
 * @deprecated use {@link DefaultStringEntityReferenceSerializer} instead.
 */
@Component
@Singleton
@Deprecated
