...
/**
 * Factory for SHA-256 Digest with RSA encryption signature processing.
 *
 * @version $Id$
 * @since 5.4RC1
 */
@Component(hints = { "SHA256withRSAEncryption", "1.2.840.113549.1.1.11" })
@Singleton
public class BcSHA256withRsaSignerFactory extends AbstractBcSignerFactory
{
