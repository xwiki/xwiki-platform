...
/**
 * Unit tests for {@link org.xwiki.crypto.store.internal.X509KeyStore}.
 *
 * @version $Id$
 * @since 6.0
 */
...
public class X509KeyStoreTest
{
    ...
    public MockitoComponentMockingRule<KeyStore> mocker =
        new MockitoComponentMockingRule<KeyStore>(X509KeyStore.class);
    ...
    public void testStoringPrivateKeyToEmptyDocument() throws Exception
    {
        ...
        when(storeDoc.newXObject(X509CertificateStore.CERTIFICATECLASS, xcontext)).thenReturn(certObj);

        BaseObject pkObj = mock(BaseObject.class);
        when(storeDoc.newXObject(X509KeyStore.PRIVATEKEYCLASS, xcontext)).thenReturn(pkObj);

        store.store(DOC_STORE_REF, keyPair);

        verify(certObj).setStringValue(X509CertificateStore.CERTIFICATECLASS_PROP_KEYID, ENCODED_SUBJECTKEYID);
        verify(certObj).setStringValue(X509CertificateStore.CERTIFICATECLASS_PROP_ISSUER, ISSUER);
        verify(certObj).setStringValue(X509CertificateStore.CERTIFICATECLASS_PROP_SERIAL, SERIAL.toString());
        verify(certObj).setStringValue(X509CertificateStore.CERTIFICATECLASS_PROP_SUBJECT, SUBJECT);
        verify(certObj).setLargeStringValue(X509CertificateStore.CERTIFICATECLASS_PROP_CERTIFICATE, ENCODED_CERTIFICATE);
        verify(pkObj).setLargeStringValue(X509KeyStore.PRIVATEKEYCLASS_PROP_KEY, ENCODED_PRIVATEKEY);
    ...
    public void testStoringPrivateKeyToCertificateDocument() throws Exception
    {
        ...
        BaseObject certObj = mock(BaseObject.class);
        when(storeDoc.getXObject(X509CertificateStore.CERTIFICATECLASS, 0)).thenReturn(certObj);
    ...
    public void testStoringEncryptedPrivateKey() throws Exception
    {
        ...
        verify(certObj).setStringValue(X509CertificateStore.CERTIFICATECLASS_PROP_SUBJECT, SUBJECT);
        verify(certObj).setLargeStringValue(X509CertificateStore.CERTIFICATECLASS_PROP_CERTIFICATE, ENCODED_CERTIFICATE);
        verify(pkObj).setLargeStringValue(X509KeyStore.PRIVATEKEYCLASS_PROP_KEY, ENCODED_ENCRYPTED_PRIVATEKEY);
    ...
    public void testUpdatingPrivateKey() throws Exception
    {
        ...
        BaseObject pkObj = mock(BaseObject.class);
        when(storeDoc.getXObject(X509KeyStore.PRIVATEKEYCLASS)).thenReturn(pkObj);
    ...
    public void testRetrievePrivateKeyFromDocument() throws Exception
    {
        ...
        BaseObject certObj = mock(BaseObject.class);
        when(storeDoc.getXObject(X509CertificateStore.CERTIFICATECLASS)).thenReturn(certObj);
        when(certObj.getLargeStringValue(X509CertificateStore.CERTIFICATECLASS_PROP_CERTIFICATE)).thenReturn(ENCODED_CERTIFICATE);

        BaseObject pkObj = mock(BaseObject.class);
        when(storeDoc.getXObject(X509KeyStore.PRIVATEKEYCLASS)).thenReturn(pkObj);
        when(pkObj.getLargeStringValue(X509KeyStore.PRIVATEKEYCLASS_PROP_KEY)).thenReturn(ENCODED_PRIVATEKEY);
    ...
    public void testRetrieveEncryptedPrivateKeyFromDocument() throws Exception
    {
        ...
        BaseObject pkObj = mock(BaseObject.class);
        when(storeDoc.getXObject(X509KeyStore.PRIVATEKEYCLASS)).thenReturn(pkObj);
        when(pkObj.getLargeStringValue(X509KeyStore.PRIVATEKEYCLASS_PROP_KEY)).thenReturn(ENCODED_ENCRYPTED_PRIVATEKEY);
