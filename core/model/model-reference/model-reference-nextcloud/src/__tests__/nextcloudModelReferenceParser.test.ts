...
describe("NextcloudModelReferenceParser", () => {
  const nextcloudModelReferenceParser = new NextcloudModelReferenceParser();
  it("parse single segment reference", () => {
    const entityReference = nextcloudModelReferenceParser.parse("a");
  ...
  it("parse many segments reference", () => {
    const entityReference = nextcloudModelReferenceParser.parse("a.x/b/c");
    expect(entityReference).toEqual(
  ...
  it("parse attachments", () => {
    const entityReference = nextcloudModelReferenceParser.parse(
