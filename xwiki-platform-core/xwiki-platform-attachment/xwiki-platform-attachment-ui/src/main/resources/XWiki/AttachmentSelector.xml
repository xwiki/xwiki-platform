...
<xwikidoc version="1.5" reference="XWiki.AttachmentSelector" locale="">
  <web>XWiki</web>
...
{{/velocity}}</code>
  ...
  <object>
    ...
    <number>19</number>
    <className>XWiki.WikiMacroParameterClass</className>
    <guid>8f5e90e1-5171-4519-b6e9-e11cc36529f1</guid>
    <class>
      <name>XWiki.WikiMacroParameterClass</name>
      <customClass/>
      <customMapping/>
    ...
    <property>
      <description>Whether to allow the user to enter a version summary that will be recorded in the history. An automatic message is used when no version summary is provided or if the version summary input is not displayed.</description>
    </property>
    <property>
      <mandatory>0</mandatory>
    </property>
    <property>
      <name>versionSummary</name>
    </property>
    <property>
      <type/>
    </property>
