...
/**
 * Specialized implementation of {@link SkinReferenceSerializer} to serialize {@link DocumentSkinReference}
 * references.
 *
 * @since 6.4M2
 * @version $Id$
 */
@Component
@Named("org.xwiki.lesscss.skin.DocumentSkinReference")
@Singleton
public class DocumentSkinReferenceSerializer implements SkinReferenceSerializer
{
    @Inject
    ...
    public String serialize(SkinReference skinReference)
    {
        ...
        return String.format("SkinDocument[%s]", entityReferenceSerializer.serialize(docSkinRef.getSkinDocument()));
    }
}
