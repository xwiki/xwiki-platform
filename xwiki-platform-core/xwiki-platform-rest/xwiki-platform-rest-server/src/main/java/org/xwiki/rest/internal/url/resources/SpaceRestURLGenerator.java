...
@Component
@Singleton
public class SpaceRestURLGenerator extends AbstractParametrizedRestURLGenerator<SpaceReference>
{
    @Override
    public URL getURL(SpaceReference reference) throws XWikiRestException
    {
        ...
        try {
            ...
            throw new XWikiRestException(
                String.format("Failed to generate a REST URL for the space [%s].", reference), e);
        }
    }
}
