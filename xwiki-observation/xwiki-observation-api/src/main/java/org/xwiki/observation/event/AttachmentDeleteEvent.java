 ...
 * @version $Id$
 */
public class AttachmentDeleteEvent extends AbstractAttachmentEvent
{
    /**
     ...
     */
    public AttachmentDeleteEvent(String documentName, String name)
    {
     ...
     */
    public AttachmentDeleteEvent(EventFilter eventFilter)
    {
        super(eventFilter);
    }
}
