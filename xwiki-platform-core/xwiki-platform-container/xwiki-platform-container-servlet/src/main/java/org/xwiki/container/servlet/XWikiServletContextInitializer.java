 ...
 * @since 42.0.0
 */
public class XWikiServletContextInitializer implements ServletContextListener
{
    /**
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent)
    {
        ...
        try {
            ...
            containerInitializer
                .initializeApplicationContext(ServletBridge.toJavax(servletContextEvent.getServletContext()));
        } catch (ComponentLookupException e) {
