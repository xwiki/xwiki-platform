...
/**
 * Required rights configuration properties.
 *
 * @version $Id$
 * @since 15.9RC1
 */
@Role
public interface RequiredRightsConfiguration
{
    /**
     ...
     * @version $Id$
     */
    enum RequiredRightDocumentProtection
    {
        /**
         * The required rights are not activated.
         */
        NONE,
        /**
     ...
     */
    RequiredRightDocumentProtection getDocumentProtection();
}
