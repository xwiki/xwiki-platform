...
{
    @Override
    public MutableServletRequest newInstance(javax.servlet.ServletRequest request)
    {
        return new JavaxToJakartaMutableHttpServletRequest(newInstance(ServletBridge.toJakarta(request)));
    }
