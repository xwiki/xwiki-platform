 ...
 */
@Component
@Named(ScopeNotificationApplicationFilter.FILTER_NAME)
@Singleton
public class ScopeNotificationApplicationFilter extends AbstractScopeNotificationFilter
{
    static final String FILTER_NAME = "scopeNotifApplicationFilter";
            ...
            NotificationPreference preference)
    {
        ...
        return (preference.getProperties().containsKey(NotificationPreferenceProperty.APPLICATION_ID)
                && scope.isWatchList()
                && scope.getApplicationId().equals(
    ...
    protected boolean scopeMatchesFilteringContext(NotificationPreferenceFilterScope scope, NotificationFormat format,
            Event event)
    {
        return scope.getApplicationId().equals(event.getApplication());
    }

    @Override
    public boolean matchesPreference(NotificationPreference preference)
    {
        return preference.getCategory().equals(NotificationPreferenceCategory.WATCHLIST)
