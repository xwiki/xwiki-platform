...
{
    /**
     * Returns the revision history of a page (of its default translation), one entry per stored version.
     *
     ...
     * @param pageName the name of the page whose history is returned, for example {@code WebHome}
     ...
     * @return the requested window of page revisions, each carrying that version's number, date, author and comment
