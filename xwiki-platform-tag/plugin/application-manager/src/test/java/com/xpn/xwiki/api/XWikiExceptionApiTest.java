...
/**
 * Unit tests for {@link com.xpn.xwiki.XWikiExceptionApi}.
 *
 * @version $Id: $
 */
public class XWikiExceptionApiTest extends TestCase
{
    ...
    public void testGetStaticErrorCode() throws XWikiException
    {
    	...
    	assertEquals("Error code is incorrect", XWikiException.ERROR_XWIKI_UNKNOWN, exceptionapi.get("ERROR_XWIKI_UNKNOWN"));
    	assertEquals("Error code is incorrect", XWikiException.ERROR_XWIKI_EXPORT_XSL_FILE_NOT_FOUND, exceptionapi.get("ERROR_XWIKI_EXPORT_XSL_FILE_NOT_FOUND"));
    	assertEquals("Error code is incorrect", XWikiException.ERROR_XWIKI_CONTENT_LINK_INVALID_URI, exceptionapi.get("ERROR_XWIKI_CONTENT_LINK_INVALID_URI"));
    }
    ...
    public void testGetExtendedStaticErrorCode() throws XWikiException
    {
    	...
    	assertEquals("Error code is incorrect", SomeExtendedException.ERROR_EXTENDED_ERROR1, exceptionapi1.get("ERROR_EXTENDED_ERROR1"));
    	assertEquals("Error code is incorrect", SomeExtendedException.ERROR_EXTENDED_ERROR2, exceptionapi1.get("ERROR_EXTENDED_ERROR2"));
    	
    	XWikiExceptionApi exceptionapi2 = new XWikiExceptionApi(new SomeOtherExtendedException(), null);
    	
    	assertEquals("Error code is incorrect", SomeOtherExtendedException.ERROR_EXTENDED_ERROR1, exceptionapi2.get("ERROR_EXTENDED_ERROR1"));
        assertEquals("Error code is incorrect", SomeOtherExtendedException.ERROR_EXTENDED_ERROR2, exceptionapi2.get("ERROR_EXTENDED_ERROR2"));
    }
}
