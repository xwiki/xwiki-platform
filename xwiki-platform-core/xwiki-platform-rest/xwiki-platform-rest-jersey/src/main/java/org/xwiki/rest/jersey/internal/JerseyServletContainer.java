...
public class JerseyServletContainer extends HttpServlet
{
    ...
    public void init() throws ServletException
    {
        ...
        try {
            newContainer.init(ServletBridge.toJavax(getServletConfig()));
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException
    {
        ...
        try {
            // Execute the request
            this.container.service(ServletBridge.toJavax(req), ServletBridge.toJavax(res));
        } catch (javax.servlet.ServletException e) {
            throw new ServletException(e);
        } finally {
    ...
    {
        return ServletBridge.toJakarta(this.container.getServletContext());
    }
}
