...
public class InvitationManagerException extends XWikiException
{
    ...
    public InvitationManagerException(int module, int code, String message)
    {
        super(module, code, message);
    }

    public InvitationManagerException(int module, int code, String message, Exception e)
    {
        super(module, code, message, e);
    }

    public InvitationManagerException(XWikiException e)
    {
        super();
