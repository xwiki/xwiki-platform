  ...
  >
    ...
    <template #body>
      ...
      >
        <template #item="{ element: sortEntry, index: level }">
          <!--
            ...
            XWikiDraggable one
          -->
          <XWikiDraggableItem class="sort-entry">
            <!-- Property name -->
            <span>{{
              logic.getPropertyDescriptor(sortEntry.property).name
            }}</span>
            ...
            <select
              ...
              "
            >
              <option value="false" :selected="!sortEntry.descending">
                {{ $t("livedata.panel.sort.direction.ascending") }}
              </option>
              <option value="true" :selected="sortEntry.descending">
      ...
      >
        ...
        -->
        <option value="none" ref="selectPropertiesNone" selected disabled>
...
export default {
  ...
  methods: {
    ...
    reorderSorts(e) {
      this.logic
        .reorderSort(e.moved.element.property, e.moved.newIndex)
