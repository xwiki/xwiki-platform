 ...
 * <li>data: the {@link NetworkMember} which left</li>
 * </ul>
 * 
 * @version $Id$
 * @since 17.9.0RC1
...
public class NetworkMemberLeftEvent implements Event
{
     ...
     */
    public NetworkMemberLeftEvent(String channel)
    {
    ...
    {
        return otherEvent instanceof NetworkMemberLeftEvent leaderEvent
