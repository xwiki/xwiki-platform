...
public class PageResourceIT extends AbstractHttpIT
{
    ...
    public void testGETNotExistingTranslation() throws Exception
    {
        ...
        CloseableHttpResponse getMethod = executeGet(buildURI(PageResource.class, getWiki(),
            TestConstants.TEST_SPACE_NAME, TestConstants.TRANSLATIONS_PAGE_NAME));
        Assert.assertEquals(HttpStatus.SC_OK, getMethod.getCode());
        ...
        Assert.assertEquals(HttpStatus.SC_NOT_FOUND, getMethod.getCode());
    }
