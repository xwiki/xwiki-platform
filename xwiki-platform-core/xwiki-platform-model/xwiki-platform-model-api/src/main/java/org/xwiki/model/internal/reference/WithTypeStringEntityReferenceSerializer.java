...
/**
 * A variation of {@link DefaultStringEntityReferenceSerializer} which prefix the reference with the type.
 * 
 * @version $Id$
 * @since 14.8RC1
 */
...
@Named("withtype")
@Singleton
public class WithTypeStringEntityReferenceSerializer extends DefaultStringEntityReferenceSerializer
{
    @Override
