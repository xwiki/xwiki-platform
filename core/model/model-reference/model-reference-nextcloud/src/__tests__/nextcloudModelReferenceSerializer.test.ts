...
describe("NextcloudModelReferenceSerializer", () => {
  const nextcloudModelReferenceSerializer =
    new NextcloudModelReferenceSerializer();
  it("serialize a simple space reference", () => {
    const url = nextcloudModelReferenceSerializer.serialize(
