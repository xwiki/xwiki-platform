 ...
 */
@ComponentTest
class MiscWysiwygCleaningTest extends AbstractHTMLCleaningTest
{
    /**
     * Test cleaning of HTML paragraphs with namespaces specified.
     */
    @Test
    void paragraphsWithNamespaces()
    {
        String html = this.header + "<w:p>paragraph</w:p>" + this.footer;
        ...
        Document doc = this.wysiwygHTMLCleaner.clean(new StringReader(html), configuration);
