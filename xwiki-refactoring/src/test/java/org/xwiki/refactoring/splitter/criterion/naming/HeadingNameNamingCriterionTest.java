...
public class HeadingNameNamingCriterionTest extends AbstractRenderingTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        xwikiParser = (Parser) getComponentManager().lookup(Parser.ROLE, "xwiki/2.0");
        docBridge = (DocumentAccessBridge) getComponentManager().lookup(DocumentAccessBridge.ROLE, "default");
        rendererFactory = (PrintRendererFactory) getComponentManager().lookup(PrintRendererFactory.ROLE, "default");
    }
