...
@Component
@Singleton
public class DefaultEntityNameValidationConfiguration implements EntityNameValidationConfiguration
{
    @Inject
    ...
    @Override
    public String getEntityNameValidation()
    {
        return configurationSource.getProperty("currentStrategy", ReplaceCharacterEntityNameValidation.COMPONENT_NAME);
    }
