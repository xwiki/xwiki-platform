...
@Named("group")
@Singleton
public class GroupMimeMessageFactory extends AbstractIteratorMimeMessageFactory<DocumentReference>
{
    ...
    @Override
    public Iterator<MimeMessage> createMessage(Session session, DocumentReference groupReference,
