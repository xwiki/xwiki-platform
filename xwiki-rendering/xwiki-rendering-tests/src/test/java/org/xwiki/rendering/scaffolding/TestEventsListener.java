...
public class TestEventsListener implements Listener
{
    ...
    {
        writeMacroData("onMacro", name, parameters, content);
    }
    ...
    {
        writeMacroData("beginMacroMarker", name, parameters, content);
    }
    ...
    private void writeMacroData(String eventName, String name, Map<String, String> parameters, String content)
    {
        StringBuffer buffer = new StringBuffer();
        ...
        write(eventName + ": [" + name + "] [" + buffer.toString() + "] [" + content + "]");
    }
}
