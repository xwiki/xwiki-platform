...
public abstract class AbstractHttpIT
{
    ...
    protected CloseableHttpResponse executePut(String uri, String string, String mediaType, TestCredentials credentials)
        throws Exception
    {
        TestCredentials defaultCredentials = this.testUtils.getDefaultCredentials();
    ...
    protected CloseableHttpResponse executeDelete(String uri, TestCredentials credentials) throws Exception
    {
        TestCredentials defaultCredentials = this.testUtils.getDefaultCredentials();
