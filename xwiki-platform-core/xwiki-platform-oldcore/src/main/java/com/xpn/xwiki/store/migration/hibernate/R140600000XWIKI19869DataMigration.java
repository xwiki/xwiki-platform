 ...
 * IMPORTANT: note that this migration is executed for version 140403000: this migration has been cherry-picked from
 * 14.06RC1 and we kept the name of the class because we use it in several artifacts (a listener, some properties, some
 * file names).
 *
 * @version $Id$
 * @since 14.6RC1
...
public class R140600000XWIKI19869DataMigration extends AbstractHibernateDataMigration
{
    ...
    {
        // This version is acccurate: it's not in sync with the class version because the class is coming from
        // a cherry-pick. See the class javadoc for explanations.
        return new XWikiDBVersion(140403000);
    }
    ...
    public boolean shouldExecute(XWikiDBVersion startupVersion)
    {
        ...
        if (getXWikiContext().isMainWiki()) {
            ...
            // The migration has been cherry-picked in 13.10.08
            return !(version >= 131008000 && version < 140000000);
        } else {
            return false;
        }
    }
