...
/*#####################################################
    ...
    var image_down = "$xwiki.getSkinFile("icons/table/arrow-down.gif")";
    var image_none = "$xwiki.getSkinFile("icons/table/arrow-none.gif")";
...
function ts_resortTable(lnk) {
	...
	if (itm.match(/^[г$─?ве]/)) sortfn = ts_sort_currency;
