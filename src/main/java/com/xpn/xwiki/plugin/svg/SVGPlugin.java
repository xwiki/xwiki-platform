...
public class SVGPlugin extends XWikiDefaultPlugin implements XWikiPluginInterface {
    ...
    public void outputSVGImage(String content, int height, int width, XWikiContext context) throws IOException, SVGConverterException {
    ...
    public String getSVGImageURL(String content, int height, int width, XWikiContext context) throws IOException, SVGConverterException {
