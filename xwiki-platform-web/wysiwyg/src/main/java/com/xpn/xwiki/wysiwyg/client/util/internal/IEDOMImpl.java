...
public class IEDOMImpl extends DOMImplTrident
{
    ...
    /*-{
        @com.xpn.xwiki.wysiwyg.client.util.internal.IEDOMImpl::dispatchEvent = function() {
    ...
    /*-{
        ...
        if ((chMask & 0x08000) && elem.tagName.toLowerCase() == 'iframe') {
            ...
            if (bits & 0x08000) {
                elem.attachEvent('onload', @com.xpn.xwiki.wysiwyg.client.util.internal.IEDOMImpl::dispatchEvent);
            } else {
                elem.detachEvent('onload', @com.xpn.xwiki.wysiwyg.client.util.internal.IEDOMImpl::dispatchEvent);
            }
