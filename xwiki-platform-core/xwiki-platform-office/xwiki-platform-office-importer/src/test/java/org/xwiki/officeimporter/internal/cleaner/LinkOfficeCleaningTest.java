 ...
 */
@ComponentTest
class LinkOfficeCleaningTest extends AbstractHTMLCleaningTest
{
    /**
     ...
     */
    @Test
    void duplicateAnchorRemoving()
    {
        String html = this.header + "<div><a href=\"www.xwiki.org\">xwiki</a></div>"
            + "<a name=\"table1\"/><h1><a name=\"table1\">Sheet 1: <em>Hello</em></a></h1>"
            + "<div><a href=\"www.xwiki.org\">xwiki</a></div>" + this.footer;
     ...
     */
    @Test
    void anchorFilteringWithTOC()
    {
        String html = this.header + "<div>some text<h1><a name=\"Topic1\"/>Topic1</h1></div>" + this.footer;
        Document doc = this.officeHTMLCleaner.clean(new StringReader(html));
        NodeList nodes = doc.getElementsByTagName("a");
