...
public class XHTMLRendererTestSuite extends TestCase
{
    public static Test suite() throws Exception
    {
        ...
        suite.addTest(new ParserListenerTester("macrohtml", syntax, XHTMLRenderer.class, true, dm));
        suite.addTest(new ParserListenerTester("macrovelocity", syntax, XHTMLRenderer.class, true, dm));
        suite.addTest(new ParserListenerTester("macronowiki", syntax, XHTMLRenderer.class, true, dm));
