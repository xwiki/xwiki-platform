 ...
 * @since 12.9RC1
 */
public class DeletedRatingEvent extends AbstractRatingEvent
{
    /**
     * Default constructor.
     *
     * @param rating the old rating that has been deleted.
     */
    public DeletedRatingEvent(Rating rating)
    {
        super(rating);
    }
    ...
    {
        return otherEvent instanceof DeletedRatingEvent;
    }
}
