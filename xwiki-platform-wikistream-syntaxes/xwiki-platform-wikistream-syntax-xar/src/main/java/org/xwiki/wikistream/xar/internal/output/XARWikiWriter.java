...
public class XARWikiWriter
{
    ...
    public XARWikiWriter(String name, Map<String, Object> wikiProperties, XAROutputProperties xarProperties)
    ...
    public OutputStream newEntry(String space, String document, Locale locale) throws WikiStreamException
    {
        StringBuilder path = new StringBuilder();

        // Add space name
        path.append(space).append('/');
