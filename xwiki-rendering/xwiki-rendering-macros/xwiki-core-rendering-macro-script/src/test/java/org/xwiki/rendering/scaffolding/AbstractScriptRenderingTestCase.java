...
public abstract class AbstractScriptRenderingTestCase extends AbstractRenderingTestCase
{
    public AbstractScriptRenderingTestCase()
    {

    }

    public AbstractScriptRenderingTestCase(String testName)
    {
        super(testName);
    }
