...
public class DefaultWikiDescriptorBuilder implements WikiDescriptorBuilder
{
    ...
    public DefaultWikiDescriptor buildDescriptorObject(List<BaseObject> serverClassObjects, XWikiDocument document)
    {
        ...
        if (descriptor != null) {
            ...
            descriptor.setPrettyName(mainServerClassObject.getStringValue(
                XWikiServerClassDocumentInitializer.FIELD_WIKIPRETTYNAME));
            descriptor.setOwnerId(mainServerClassObject.getStringValue(
