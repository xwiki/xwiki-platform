 ...
 * component to resolve {@link org.xwiki.model.reference.PageAttachmentReference} objects from their string
...
@Named("explicit")
@Singleton
public class ExplicitStringPageAttachmentReferenceResolver implements PageAttachmentReferenceResolver<String>
{
    /**
    ...
    @Override
    public PageAttachmentReference resolve(String attachmentReferenceRepresentation, Object... parameters)
    {
