 ...
 */
@Component("formula")
public class FormulaMacro extends AbstractMacro<FormulaMacroParameters> implements Composable
{
    ...
    {
        try {
            FormulaRenderer renderer = (FormulaRenderer) this.manager.lookup(FormulaRenderer.class, rendererHint);
            ...
            URLImage image = new URLImage(url);
