...
/**
 * {@link RequiredRightAnalyzer} for {@code XWiki.Notifications.Code.NotificationFilterDisplayerClass} objects.
 *
 * @version $Id$
 * @since 15.10.16
 * @since 16.4.7
...
@Singleton
public class XWikiNotificationFilterDisplayerRequiredRightAnalyzer implements RequiredRightAnalyzer<BaseObject>
{
    @Inject
