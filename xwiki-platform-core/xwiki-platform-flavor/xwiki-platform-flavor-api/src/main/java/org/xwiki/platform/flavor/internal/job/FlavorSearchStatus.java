 ...
 * @since 8.0RC1
 */
public class FlavorSearchStatus extends DefaultExtensionPlan<FlavorSearchRequest>
{
    /**
     * @see #getFlavors()
     */
     ...
     */
    public FlavorSearchStatus(FlavorSearchRequest request, ObservationManager observationManager,
