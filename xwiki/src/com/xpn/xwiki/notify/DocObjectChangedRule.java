...
public class DocObjectChangedRule extends DocChangeRule {
    ...
    public DocObjectChangedRule(XWikiNotificationInterface target) {
        setTarget(target);
    }

    public DocObjectChangedRule(XWikiNotificationInterface target,String classname) {
        setTarget(target);
        setClassName(classname);
    }

    public boolean hasEqualsObjectsFromClass(XWikiDocInterface newdoc, XWikiDocInterface olddoc, String classname) {
    ...
    public boolean hasEqualsObjectsForAllClasses(XWikiDocInterface newdoc, XWikiDocInterface olddoc) {
    ...
    public boolean hasEqualObjects(XWikiDocInterface newdoc, XWikiDocInterface olddoc, String className) {
        if (className==null)
