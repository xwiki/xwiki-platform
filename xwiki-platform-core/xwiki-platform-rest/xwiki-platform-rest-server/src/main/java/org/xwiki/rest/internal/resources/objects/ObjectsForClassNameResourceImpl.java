...
import org.xwiki.rest.resources.objects.ObjectsForClassNameResource;
...
{
    @Override
    public Objects getObjects(String wikiName, String spaceName, String pageName, String className, Integer start,
