...
public class XWikiDocument implements DocumentModelBridge, Cloneable
{
    ...
    /**
     * Extract all the unique static (i.e. not generated by macros) wiki links (pointing to wiki entities) from the
     * context document's content to others entities (documents, attachments, etc.).
     *
     * @param context the XWiki context.
