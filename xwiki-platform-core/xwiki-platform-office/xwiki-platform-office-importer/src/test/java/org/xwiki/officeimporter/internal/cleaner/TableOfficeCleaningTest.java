 ...
 */
@ComponentTest
class TableOfficeCleaningTest extends AbstractHTMLCleaningTest
{
    /**
     * An isolated paragraph inside a table cell item should be replaced with paragraph's content.
     */
    @Test
    void tableCellItemIsolatedParagraphCleaning()
    {
     ...
     */
    @Test
    void tableHeaderItemIsolatedParagraphCleaning()
    {
