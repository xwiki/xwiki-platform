...
/**
 * Define the configuration source document for name strategies.
 *
 * @version $Id$
 * @since 12.0RC1
 */
...
@Singleton
public class NameStrategiesConfigurationSource extends AbstractDocumentConfigurationSource
{
    private static final List<String> SPACE_NAMES = Arrays.asList("XWiki", "NameStrategies");
    ...
    {
        return "configuration.document.namestrategies";
    }
}
