...
/**
 * Means that an error occurred while trying to construct an {@link XWikiURL} object.
 *
 * @version $Id$
 * @since 5.1M1
 */
@Unstable
public class URLCreationException extends Exception
{
    /**
     ...
     */
    public URLCreationException(String message, Throwable throwable)
    {
