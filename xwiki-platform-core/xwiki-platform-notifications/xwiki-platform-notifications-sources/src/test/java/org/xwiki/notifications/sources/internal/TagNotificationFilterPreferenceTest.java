...
/**
 * Tests for {@link TagNotificationFilterPreference}.
 *
 * @version $Id$
 */
public class TagNotificationFilterPreferenceTest
{
    ...
    public void equals()
    {
        ...
        pref2 = new TagNotificationFilterPreference("anothertag", "mywiki");
        assertNotEquals(pref1, pref2);
        assertNotEquals(pref1.hashCode(), pref2.hashCode());

        pref2 = new TagNotificationFilterPreference("mytag", "anotherwiki");
        assertNotEquals(pref1, pref2);
        assertNotEquals(pref1.hashCode(), pref2.hashCode());
    }
}
