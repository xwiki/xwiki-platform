...
{
    /**
     * Retrieves an object attached to a given version of a page.
     *
     ...
     * @param withPrettyName when {@code true}, also computes human-readable display names (for example the author's
     *  display name), at some extra cost; defaults to {@code false}
     * @return the requested object as stored in the given page version
     * @throws XWikiRestException if the object cannot be retrieved, for example the page or the given version does not
     *  exist
     */
