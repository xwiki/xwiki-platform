...
{
    /**
     * @return the name of the core without the prefix/suffix specific to the setup
     */
    String getName();

    /**
     * @return the real name of the core (with the prefix/suffix specific to the setup)
     */
    String getSolrName();
