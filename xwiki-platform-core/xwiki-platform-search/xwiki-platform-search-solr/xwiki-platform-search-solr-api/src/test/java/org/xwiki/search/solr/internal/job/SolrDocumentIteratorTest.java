...
public class SolrDocumentIteratorTest
{
    ...
    public void iterate() throws Exception
    {
        ...
        when(emptyResponse.getResults()).thenReturn(new SolrDocumentList());

        when(solr.query(any(SolrQuery.class))).thenReturn(firstResponse, secondResponse, emptyResponse);
