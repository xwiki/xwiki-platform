 ...
 * @since 17.10.3
 */
public abstract class AbstractExtensionTestUtils
{
    /**
     ...
     */
    protected AbstractExtensionTestUtils(TestUtils utils)
    {
        this.utils = utils;
    }
    ...
    {
        int port = this.utils.getCurrentExecutor().getHttpClientPort();
    ...
    protected abstract void assertEquals(String expect, String actual);
