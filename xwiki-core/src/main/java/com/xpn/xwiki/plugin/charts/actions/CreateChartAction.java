...
public class CreateChartAction extends XWikiAction
{
    ...
    public String render(XWikiContext context) throws XWikiException
    {
        ...
        try {
            ...
            throw new XWikiException(XWikiException.MODULE_XWIKI_PLUGINS, XWikiException.ERROR_XWIKI_UNKNOWN, e
                .getMessage(), e);
        }
        ...
        try {
            ...
            throw new XWikiException(XWikiException.MODULE_XWIKI_PLUGINS, XWikiException.ERROR_XWIKI_UNKNOWN, ex
                .getMessage(), ex);
        }
        return null;
    }
