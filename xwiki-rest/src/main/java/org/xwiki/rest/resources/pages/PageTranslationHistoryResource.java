 ...
 * @version $Id$
 */
@Component("org.xwiki.rest.resources.pages.PageTranslationHistoryResource")
@Path("/wikis/{wikiName}/spaces/{spaceName}/pages/{pageName}/translations/{language}/history")
public class PageTranslationHistoryResource extends XWikiResource
{
    @GET
    public History getPageTranslationHistory(@PathParam("wikiName") String wikiName,
