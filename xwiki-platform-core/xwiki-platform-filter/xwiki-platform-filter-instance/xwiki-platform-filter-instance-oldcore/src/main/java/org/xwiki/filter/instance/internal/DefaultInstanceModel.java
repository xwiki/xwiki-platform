...
public class DefaultInstanceModel implements InstanceModel
{
    ...
    @Override
    public List<String> getWikis() throws FilterException
    {
    ...
    @Override
    public List<String> getSpaces(String wiki) throws FilterException
    {
        try {
            return this.queryManager.getNamedQuery("getSpaces").setWiki(wiki).execute();
        } catch (QueryException e) {
            throw new FilterException(String.format("Failed to get the list of spaces in wiki [%s]", wiki), e);
        }
    }

    @Override
    public List<String> getDocuments(String wiki, String space) throws FilterException
    {
        try {
            Query query =
                this.queryManager
