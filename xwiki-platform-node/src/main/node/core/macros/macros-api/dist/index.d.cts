import { MacroBlock, MacroInlineContent } from './ast';
/**
 ...
 * @beta
 */
type Macro<Parameters extends Record<string, MacroParameterType>> = BlockMacro<Parameters> | InlineMacro<Parameters>;
/**
 ...
 * @beta
 */
type MacroClassWithUnknownParamsType = new (...args: any[]) => MacroWithUnknownParamsType;
/**
 ...
 * @beta
 */
type GetConcreteMacroParameterType<T extends MacroParameterType> = (T["type"] extends "boolean" ? boolean : T["type"] extends "float" ? number : T["type"] extends "string" ? string : never) | (T["optional"] extends true ? undefined : never);
/**
 ...
 * @beta
 */
type GetConcreteMacroParametersType<T extends Record<string, MacroParameterType>> = UndefinableToOptional<{
 ...
 * @beta
 */
export declare function eraseParamsTypeForMacroClass<Params extends Record<string, MacroParameterType>>(macro: new (...args: any[]) => Macro<Params>): MacroClassWithUnknownParamsType;
export type { BlockMacro, FilterUndefined, GetConcreteMacroParameterType, GetConcreteMacroParametersType, InlineMacro, Macro, MacroClassWithUnknownParamsType, MacroInfos, MacroParameterType, MacroWithUnknownParamsType, UndefinableToOptional, UnknownMacroParamsType, };
export type { MacroAlignment, MacroBlock, MacroBlockStyles, MacroImage, MacroInlineContent, MacroLink, MacroLinkTarget, MacroListItem, MacroTableCell, MacroTableColumn, MacroText, MacroTextStyles, } from './ast';
