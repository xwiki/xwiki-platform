...
public final class CommandManagerApi extends JavaScriptObject
{
    ...
    /*-{
        ...
        $wnd.CommandManager.prototype.execute = function(commandName, parameter) {
            var command = @com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.Command::new(Ljava/lang/String;)(commandName);
            return this.cm.@com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.CommandManager::execute(Lcom/xpn/xwiki/wysiwyg/client/widget/rta/cmd/Command;Ljava/lang/String;)(command, parameter);
        }
        $wnd.CommandManager.prototype.getValue = function(commandName) {
            var command = @com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.Command::new(Ljava/lang/String;)(commandName);
            return this.cm.@com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.CommandManager::getStringValue(Lcom/xpn/xwiki/wysiwyg/client/widget/rta/cmd/Command;)(command);
        }
        $wnd.CommandManager.prototype.isEnabled = function(commandName) {
            var command = @com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.Command::new(Ljava/lang/String;)(commandName);
            return this.cm.@com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.CommandManager::isEnabled(Lcom/xpn/xwiki/wysiwyg/client/widget/rta/cmd/Command;)(command);
        }
        $wnd.CommandManager.prototype.isExecuted = function(commandName) {
            var command = @com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.Command::new(Ljava/lang/String;)(commandName);
            return this.cm.@com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.CommandManager::isExecuted(Lcom/xpn/xwiki/wysiwyg/client/widget/rta/cmd/Command;)(command);
        }
        $wnd.CommandManager.prototype.isSupported = function(commandName) {
            var command = @com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.Command::new(Ljava/lang/String;)(commandName);
            return this.cm.@com.xpn.xwiki.wysiwyg.client.widget.rta.cmd.CommandManager::isSupported(Lcom/xpn/xwiki/wysiwyg/client/widget/rta/cmd/Command;)(command);
        }
    }-*/;
}
