 ...
 * @since 4.5M1
 */
public class DefaultResourceTranslationBundle extends AbstractResourceTranslationBundle
{
    /**
     ...
     */
    public DefaultResourceTranslationBundle(URL resourceURL, ComponentManager componentManager,
