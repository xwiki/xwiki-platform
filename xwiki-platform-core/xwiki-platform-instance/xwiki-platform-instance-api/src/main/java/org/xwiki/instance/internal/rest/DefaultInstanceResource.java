 ...
 */
package org.xwiki.instance.internal.rest;
...
public class DefaultInstanceResource extends XWikiResource implements InstanceResource
{
    ...
    {
        InstanceId instanceId = this.instanceIdManager.getInstanceId();
        return instanceId != null ? instanceId.getInstanceId() : null;
    }
}
