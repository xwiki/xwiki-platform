...
/**
 * Provides authorization for a given {@link ConfigurationSource} (each {@link ConfigurationSource} requiring
 * authorization must implement a {@link ConfigurationSourceAuthorization} component using the same role hint.
 *
 * @version $Id$
 * @since 12.4RC1
 */
