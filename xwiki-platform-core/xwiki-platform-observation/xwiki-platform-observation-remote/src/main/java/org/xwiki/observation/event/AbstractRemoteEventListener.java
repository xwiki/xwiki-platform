...
/**
 * This is a version of an {@link AbstractEventListener} that skips automatically all events that are local: only remote
 * events will be processed. This abstraction should be preferred over {@link AbstractEventListener} when the local
 ...
 * @since 18.0.0RC1
 */
public abstract class AbstractRemoteEventListener extends AbstractEventListener
{
    @Inject
     ...
     */
    protected AbstractRemoteEventListener(String name, List<? extends Event> events)
    {
        super(name, events);
    }
     ...
     *            each matching event in this list, the {@link #onEvent(Event, Object, Object)} method will be called.
     */
    protected AbstractRemoteEventListener(String name, Event... events)
    {
        super(name, events);
    }
     ...
     */
    protected AbstractRemoteEventListener(String name, Object... values)
    {
        super(name, values);
    }
    ...
    public void onEvent(Event event, Object source, Object data)
    {
        if (this.remoteObservationManagerContext.isRemoteState()) {
            processRemoteEvent(event, source, data);
        }
    }
     ...
     */
    public abstract void processRemoteEvent(Event event, Object source, Object data);
}
