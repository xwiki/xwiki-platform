...
public class RepositoryResolver
{
    ...
    {
        // If the local repository is configured when calling Maven, we should use the configured repo so that we
        // always use the same repository. This is done by passing the maven.repo.local system property.
