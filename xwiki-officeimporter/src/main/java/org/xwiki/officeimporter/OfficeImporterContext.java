...
public class OfficeImporterContext
{
     ...
     */
    private static final String DEFAULT_SYNTAX_ID = new Syntax(SyntaxType.XWIKI, "1.0").toIdString();
    ...
    public void finalizeDocument(boolean isPresentation) throws OfficeImporterException
    {
        try {
            if (!finalized) {
                docBridge.setDocumentContent(targetDocument, bufferedContent, "Generated by office importer.", false);
     ...
     */
    public void addAttachment(byte[] sourceData, String fileName)
    {
        try {
