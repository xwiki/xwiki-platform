...
public class WikiMacroIT
{
     ...
     */
    @Test
    public void bindingsAndNestedMacros(TestUtils setup, TestReference testReference)
    {
        // We need to be superadmin to have scripts rights
        setup.loginAsSuperAdmin();
        DocumentReference wikimacro1 = new DocumentReference("wikimacro1", testReference.getLastSpaceReference());
        DocumentReference wikimacro2 = new DocumentReference("wikimacro2", testReference.getLastSpaceReference());
