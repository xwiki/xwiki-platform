...
/**
 * Reference to cryptographic store in the wiki.
 *
 * @version $Id$
 * @since 6.1M1
 */
public class XWikiStoreReference implements StoreReference
{
     ...
     */
    public XWikiStoreReference(EntityReference reference) {
